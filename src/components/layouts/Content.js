      ...
      <div id="header-carousel" className="carousel slide" data-bs-ride="carousel">
        <div className="carousel-inner">
          <div className="carousel-item active" >
            ...
            <div className="carousel-caption">
              <div className="container">
                <div className="row">
                  <div className="col-12 col-lg-8"  style={{backgroundColor: 'rgba(255, 255, 255, 0.5)', padding:'25px', width:'70%'}}>
                    <h1 className="display-3 text-dark mb-1 animated slideInDown" style={{textAlign: 'left'}}>
                      Insurance Creates Wealth For Everyone
                    </h1>
                    <p className="fs-5 text-body mb-5" style={{textAlign: 'left'}}>
                      Clita erat ipsum et lorem et sit, sed stet lorem sit clita
                      duo justo magna dolore erat amet
                    </p>
                    <a href="" className="btn btn-primary py-3 px-5"
                      style={{float: 'left'}}>More Details</a
                    >
                  </div>
                </div>
              </div>
          ...
          <div className="carousel-item">
            <img className="w-100" src="https://images.pexels.com/photos/1643383/pexels-photo-1643383.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Image" />
            <div className="carousel-caption">
              <div className="container">
                <div className="row">
                  <div className="col-12 col-lg-8" style={{backgroundColor: 'rgba(255, 255, 255, 0.5)', padding:'25px', width:'70%'}}>
                    <h1 className="display-3 text-dark mb-4 animated slideInDown" style={{textAlign: 'left'}}>
